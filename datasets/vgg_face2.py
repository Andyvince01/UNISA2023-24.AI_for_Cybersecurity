...
class VGG_Faces2(data.Dataset):
    ...
    def __init__(self, root, image_list_file, name_label_dict, split='train', transform=True,
        ...
        with open(self.image_list_file, 'r') as f:
            for i, img_file in enumerate(f):
                ...
                class_name = img_file.split("/")[3]  # like n004332
                label = self.name_label_dict[class_name]
    ...
    def __getitem__(self, index):
        ...
        if self._transform:
            return self.transform(img), label, img_file, class_name
        else:
            return img, label, img_file, class_name
